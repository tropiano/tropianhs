...
Back writing something. To be honest not much has happened over the last 4 weeks so I will just write down a summary for November earnings.

The main income is always from freelancing and selling my book. I also spent some money on advertising the book in November so I will take that into account as an expense.
...
It might be that the advertising spending is the cause for the increase in book sales in Gumroad, but I doubt that the Amazon sales can be attributed to that. In fact, in October (where no advertising was in place) the revenue was around 60$. From Gumroad analytic, I see that 75 people clicked on my Ad in November and none bought the book. Probably I should consider it a failed experiemnt but let's see how it goes in December.
...
My earnings from these 2 contracts in October are a healthy 179$ after fees and taxes. It's good for a start, next step is to reach 200$ per month.
I actually spent quite a lot in AWS fees for one of these projects, around 45$. Which makes the net revenue decrease to 134$. Still good, but a long way to 200$.
...
I am seeing book sales increasing this month, in KDP we are already at 11 copied sold. This is something I expected as we approach the World Cup and the interest in football increases.

I think I will try to build some simple model for predicting World Cup matches outcome in the next days, similar to what I did for the [previous edition](https://tropianhs.netlify.app/data/2018/06/17/wc18.html). It could be a fun exercise and could be a way to enjoy the World Cup, now that Italy has not qualified (again).
...
One is an hourly contract, to do some analysis on social mdia posts with python (data aggregation and segmentation for an analytic dashboard). The other one is a fixed price contract, about automatic video making with python (using ffmpeg and other custom tools).
...
- Send a sample of my work. The video making job mentioned a tool and I took a little time to go and learn how to use it. Made a video sample and sent it to the client. He really appreaciated that, called mine a "nice proposal strategy".

Hope these tips above can help people out there that are starting freelancing. I am grateful to the tips I received from some YT videos like [this](https://youtu.be/YQ-RXMtQYYM).

Money wise, the fix contract is 50$ and the hourly one is for 15$/hour. Not life changing but something signinficant for a side job. Moreover, the clients already look like they would work with me in the future on other projects, which means stable income and projects coming in the next weeks.

The book sales keep trickling. We are at 44€ in royalties so far this month. I spent 150£ in ads for the next 3 months so I hope these will pay off long term.
